            ...
            <div className="flex-1 flex flex-col md:flex-row items-center md:items-start gap-8 bg-gradient-to-r from-primary/20 via-primary/5 to-transparent border-l-4 border-l-primary border-y border-r border-primary/20 rounded-none p-8 md:p-10 relative overflow-hidden">
              <div className="relative shrink-0 z-10">
                ...
                {user.roles?.includes("ADMIN") && (
                  <div className="absolute -bottom-2 -right-2 bg-red-500 text-white text-[8px] md:text-[10px] font-black uppercase tracking-widest px-3 md:px-4 py-1 md:py-1.5 rounded-xl border-2 md:border-4 border-neutral-900 shadow-xl transform rotate-12">
                    Admin
                  </div>
                )}
              </div>
              ...
              {isOwnProfile && (
                <div className="hidden md:flex absolute top-8 right-8 flex-row items-center gap-3 z-20">
                  ...
                  <button 
                    onClick={handleLogout}
                    className="flex items-center gap-2 px-5 py-2.5 bg-red-500/10 text-red-500 border border-red-500/20 rounded-none text-[10px] font-black uppercase tracking-widest transition-all hover:bg-red-500 hover:text-white active:scale-95"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
                    Logout
                  </button>
