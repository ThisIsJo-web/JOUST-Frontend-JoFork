          ...
          <div className="bg-[#141414] border border-white/5 p-8 md:p-10 rounded-[2rem] shadow-[0_40px_100px_rgba(0,0,0,0.8)] relative overflow-hidden">
            ...
            <div className="bg-black/40 p-1 rounded-xl flex mb-8 border border-white/5">
              <button
                ...
                className={`flex-1 py-2.5 font-black text-[10px] uppercase tracking-widest transition-all rounded-lg font-poppins ${
                  mode === "login"
            ...
            <form onSubmit={handleSubmit} className="space-y-5 relative">
              ...
              {message && (
                <div className={`p-3 text-[10px] font-black uppercase tracking-widest text-center rounded-lg animate-in fade-in duration-300 ${
              ...
              <button
                type="submit"
                className="w-full h-14 bg-primary text-white font-black text-[11px] uppercase tracking-[0.2em] hover:brightness-110 active:scale-[0.98] transition-all rounded-xl shadow-xl shadow-primary/20 font-poppins mt-2"
              >
                {mode === "login" ? "ENTER ARENA" : "JOIN ARENA"}
              </button>
            </form>

            <p className="mt-8 text-center text-[9px] font-bold text-gray-600 uppercase tracking-[0.2em] leading-relaxed font-questrial">
              Authorized access only. System telemetry is active.
            </p>
          </div>
        </div>
      </main>
