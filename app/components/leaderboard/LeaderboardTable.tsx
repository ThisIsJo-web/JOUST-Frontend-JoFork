...
export default function LeaderboardTable({ entries, loading, variant = "default", limit }: LeaderboardTableProps) {
  ...
  if (variant === "bento") {
    return (
      <div className="h-full flex flex-col bg-black border-4 border-white overflow-hidden">
        <div className="p-6 border-b-4 border-white flex items-center justify-between bg-black shrink-0">
            ...
            {displayEntries.map((entry, idx) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-10 h-10 bg-[#1B1B1B] border border-white/10 flex items-center justify-center font-black text-xs text-primary">
  ...
  return (
    <div className="bg-black border-4 border-white shadow-[16px_16px_0px_0px_#52B946] overflow-hidden">
      ...
      <div className="p-10 border-b-8 border-white flex flex-col md:flex-row md:items-end justify-between gap-8 bg-black">
      ...
      <div className="w-full overflow-x-auto selection:bg-primary selection:text-black no-scrollbar">
        <table className="w-full text-left border-collapse min-w-[900px]">
          <thead>
            <tr className="bg-[#1B1B1B]/50 border-b-4 border-white">
              ...
              >
                ...
                <td className="py-8 px-10">
                  <div className="flex items-center gap-8">
                    <div className="w-14 h-14 bg-[#1B1B1B] border-2 border-white/10 group-hover:border-primary flex items-center justify-center font-black text-2xl text-primary transition-all">
                ...
                <td className="py-8 px-10 text-center">
                  <div className="inline-flex items-center gap-4 px-6 py-2.5 bg-[#1B1B1B] border border-white/10">
