...
export default function ManagerTournamentTable({ tournaments, onComplete }: ManagerTournamentTableProps) {
  return (
    <div className="w-full bg-[#1B1B1B] border border-white/10 rounded-[4px] overflow-hidden">
      <table className="w-full text-left border-collapse">
        <thead className="bg-[#1B1B1B] border-b border-white/10">
          <tr>
            <th className="p-4 text-[11px] font-black uppercase tracking-widest text-white/30">Tournament Name</th>
            <th className="p-4 text-[11px] font-black uppercase tracking-widest text-white/30">Game Context</th>
          ...
          {tournaments.length === 0 && (
            <tr>
              <td colSpan={6} className="p-20 text-center">
                <p className="text-[10px] font-black text-white/20 uppercase tracking-[0.5em]">NO TOURNAMENTS FOUND</p>
